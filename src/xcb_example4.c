...
xcb_drawable_t create_sub_window(xcb_drawable_t parent, xcb_gravity_t gravity) {
  ...
  xcb_create_window(c, XCB_COPY_FROM_PARENT, swin, win, 0, 0, 50, 50, 2,
...
void create_window() {
  ...
  xcb_create_window(
      c, screen->root_depth, win, screen->root, 0, 0, 54,
      54, /* border size big enough for the subwindows to fit in */
